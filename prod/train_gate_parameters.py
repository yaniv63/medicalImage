...
e = model.get_weights()
model.load_weights('/media/sf_shared/src/medicalImaging/runs/MOE runs/run14- freeze all experts,train combined/soft_label/latest/model_merge_1_fold_0.h5',by_name=True)
