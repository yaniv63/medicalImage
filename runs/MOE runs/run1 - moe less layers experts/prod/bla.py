...
def train_combined(model,PersonTrainList,PersonValList,contrast_list,view_list,name,batch_size=256):
    ...
    history = model.fit_generator(train_generator, samples_per_epoch=epoch_size, nb_epoch=10, callbacks=callbacks,
...
for train_index, test_index in kf.split(data):
    ...
    for contrast_type,view_type in product(MR_modalities,view_list):
