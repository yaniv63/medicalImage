...
w_path_gate = '/media/sf_shared/src/medicalImaging/runs/MOE runs/run9-pretrain gate parameters/temp/'
...
def load_model(weight_dir,args):
    ...
    combined_model = n_parameters_combined_model(n=args['n'],N_mod=4)
