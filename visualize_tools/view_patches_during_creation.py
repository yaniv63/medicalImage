...
for index in range(1, 6):
    for index2 in range(1, 5):
        ...
        print "i'm here"
        patches_axial, patches_coronal, patches_labels = sample_negative_samples(patches_axial, patches_coronal,
                                                                                 patches_labels)
        ...
        axial_train, axial_train_labels, axial_val, axial_val_labels = split_train_validation(patches_axial,
                                                                                              patches_labels, valSize)
        coronal_train, coronal_train_labels, coronal_val, coronal_val_labels = split_train_validation(patches_coronal,
                                                                                                      patches_labels,
                                                                                                      valSize)
