...
sample_patches_filename = r"/media/sf_shared/src/medicalImaging/ref/sample_patches.npz"
...
def create_full_model():
    ...
    for ch in range(img_channels):
        ...
        graph.add_node(layer=s_model, name='s%d' % (ch),
                       inputs=['s%d_curr_model_node' % (ch), 's%d_prev_model_node' % (ch)],
...
axarr[0,0].imshow(a[0][0,1,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
axarr[0,1].imshow(a[0][0,2,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
axarr[1,0].imshow(a[0][0,3,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
axarr[1,1].imshow(a[0][1,1,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')

f,axarr2 = pylab.subplots(2,2)
axarr2[0,0].imshow(b[0][0,1,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
axarr2[0,1].imshow(b[0][0,2,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
axarr2[1,0].imshow(b[0][0,3,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
axarr2[1,1].imshow(b[0][1,1,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
#pylab.imshow(b[0,:,:], cmap=matplotlib.cm.gray, interpolation='nearest')
pylab.show()
# compile net
